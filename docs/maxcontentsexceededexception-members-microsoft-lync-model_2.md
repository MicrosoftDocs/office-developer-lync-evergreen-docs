---
title: MaxContentsExceededException members (Microsoft.Lync.Model)
TOCTitle: MaxContentsExceededException members
ms:assetid: AllMembers.T:Microsoft.Lync.Model.MaxContentsExceededException_DI_3_UC_OCS14MrefLyncWPF
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.lync.model.maxcontentsexceededexception_di_3_uc_ocs14mreflyncwpf_members(v=office.15)
ms:contentKeyID: 48596384
ms.date: 07/28/2014
mtps_version: v=office.15
---

# MaxContentsExceededException members
...
The [MaxContentsExceededException](maxcontentsexceededexception-class-microsoft-lync-model_2.md) type exposes the following members.
...
<td><a href="maxcontentsexceededexception-constructor-microsoft-lync-model_1.md">MaxContentsExceededException</a></td>
<td>Initializes a new instance of the MaxContentsExceededException class with serialized data.</td>
</tr>
</tbody>
</table>
