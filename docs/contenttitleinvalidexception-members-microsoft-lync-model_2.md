---
title: ContentTitleInvalidException members (Microsoft.Lync.Model)
TOCTitle: ContentTitleInvalidException members
ms:assetid: AllMembers.T:Microsoft.Lync.Model.ContentTitleInvalidException_DI_3_UC_OCS14MrefLyncWPF
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.lync.model.contenttitleinvalidexception_di_3_uc_ocs14mreflyncwpf_members(v=office.15)
ms:contentKeyID: 48597686
ms.date: 07/28/2014
mtps_version: v=office.15
---

# ContentTitleInvalidException members
...
The [ContentTitleInvalidException](contenttitleinvalidexception-class-microsoft-lync-model_2.md) type exposes the following members.
...
<td><a href="contenttitleinvalidexception-constructor-microsoft-lync-model_1.md">ContentTitleInvalidException</a></td>
<td>Initializes a new instance of the ContentTitleInvalidException class with serialized data.</td>
</tr>
</tbody>
</table>
...
<tr class="odd">
<td><img src="images/JJ275421.pubproperty(Office.15).gif" title="Public property" alt="Public property" /></td>
<td><a href="lyncclientexception-internalcode-property-microsoft-lync-model_2.md">InternalCode</a></td>
<td>returns COM HRESULT for the exception. (Inherited from <a href="lyncclientexception-class-microsoft-lync-model_2.md">LyncClientException</a>.)</td>
</tr>
<tr class="even">
<td><img src="images/JJ275421.pubproperty(Office.15).gif" title="Public property" alt="Public property" /></td>
...
[ContentTitleInvalidException class](contenttitleinvalidexception-class-microsoft-lync-model_2.md)
