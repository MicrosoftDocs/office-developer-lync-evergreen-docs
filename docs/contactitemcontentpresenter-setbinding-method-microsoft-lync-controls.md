---
title: ContactItemContentPresenter.SetBinding method  (Microsoft.Lync.Controls)
TOCTitle: 'SetBinding method '
ms:assetid: Overload:Microsoft.Lync.Controls.ContactItemContentPresenter.SetBinding_DI_3_UC_OCS14MrefLyncWPF
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.lync.controls.contactitemcontentpresenter.setbinding_di_3_uc_ocs14mreflyncwpf(v=office.15)
ms:contentKeyID: 48597548
ms.date: 07/28/2014
mtps_version: v=office.15
f1_keywords:
- Microsoft.Lync.Controls.ContactItemContentPresenter.SetBinding
dev_langs:
- CSharp
- JScript
- VB
...
# ContactItemContentPresenter.SetBinding method
