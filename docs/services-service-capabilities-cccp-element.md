---
title: services/service/capabilities/CCCP element
TOCTitle: services/service/capabilities/CCCP element
ms:assetid: 19d058f0-c803-40f6-9d13-56b8a93e6c79
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Dn454785(v=office.15)
ms:contentKeyID: 57093672
ms.date: 07/24/2014
...
# services/service/capabilities/CCCP element


_**Applies to:** Lync 2013 | Lync Server 2013_

Specifies the service capability for CCCP.
...
The following XML code snippet describes a service capability to handle CCCP for the user, sip:alice@contoso.com.

    <se:service xmlns:se="http://schemas.microsoft.com/2006/09/sip/service">
      <se:capabilities>
        <se:CCCP uri="sip:alice@contoso.com" render="true" publish="true" />
      </se:capabilities>
    </se:service>
