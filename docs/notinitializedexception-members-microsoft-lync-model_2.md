---
title: NotInitializedException members (Microsoft.Lync.Model)
TOCTitle: NotInitializedException members
ms:assetid: AllMembers.T:Microsoft.Lync.Model.NotInitializedException_DI_3_UC_OCS14MrefLyncWPF
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.lync.model.notinitializedexception_di_3_uc_ocs14mreflyncwpf_members(v=office.15)
ms:contentKeyID: 48588602
ms.date: 07/28/2014
...
The [NotInitializedException](notinitializedexception-class-microsoft-lync-model_2.md) type exposes the following members.
...
<td><a href="notinitializedexception-constructor-microsoft-lync-model_1.md">NotInitializedException</a></td>
<td>Initializes a new instance of the NotInitializedException class with serialized data.</td>
</tr>
</tbody>
</table>
