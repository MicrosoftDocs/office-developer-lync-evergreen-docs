...
ms:mtpsurl: https://msdn.microsoft.com/library/JJ933178(v=office.15)
ms:contentKeyID: 50877331
ms.date: 07/24/2014
...
Whiteboard annotations overview<br />
Prerequisites<br />
First steps<br />
Save content annotations<br />
Clear content annotations<br />
...
The prerequisites for saving and clearing annotations are as follows:
...
<td><p>Learn how to share a whiteboard collaboration session in a Lync 2013 conversation by using Microsoft Lync 2013 SDK.</p></td>
</tr>
</tbody>
</table>
...
```csharp
    ...
    {
        ((ContentSharingModality)_conversation.Modalities[ModalityTypes.ContentSharing]).ActiveContent.ClearAllAnnotations();
    }
```
...
namespace ContentSharing
{
    public partial class ContentSharing_Form : Form
    {
        ...
        {
            //15.0 - Create and upload a PowerPoint slide deck.
        ...
        {
            //11.0 - Connect content sharing modality
            ...
            object sender, ModalityActionAvailabilityChangedEventArgs e)
        {
            ...
            switch (e.Action)
            {
                case ModalityAction.CreateShareableNativeFileOnlyContent:
                    ...
                    //9.0 - create and upload native file content
                ...
                case ModalityAction.CreateShareablePowerPointContent:
                    ...
                    //9.1 - Create shareable powerpoint content
        ...
        {
            //14.9 - Add the new content bin item to the UI list
        ...
        {
            //14.4 - Present the content on the sharing stage
        ...
        {
            //15.1 - Return to meeting view of PowerPoint presentation
        ...
        {
            //15.2 - scroll to next slide in PPT deck.
        ...
        {
            //15.3 - Scroll to previous slide in PPT deck.
        ...
        {
            //14.6 - Clear annotiations from the active content
        ...
        private void EndConversation_Button_Click(object sender, EventArgs e)
        {
            ...
            //14.8 - Clean up event registration and end conversation
        ...
        private void SaveAnnotations_Button_Click(object sender, EventArgs e)
        {
            //14.7 - Save the annotations on the active content
        ...
        private void ContentSharing_Form_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //2.0 - Get client platform

                //Get the API entry point
                _LyncClient = LyncClient.GetClient();

                //2.1 - Check for UI suppression
        ...
        {
            //4.0 - Create new Conversation object for new meeting
        ...
        private void DownloadAttachment_Button_Click(object sender, EventArgs e)
        {
            ...
            //14.0 - get download target folder
            ...
            //14.1 - Get shareable content out of meeting content bin to download
            ...
            //14.2 - download the file

            if (contentToDownload != null)
            {
                //14.2 - download content
            ...
            object sender, Microsoft.Lync.Model.Conversation.ConversationManagerEventArgs e)
        {
            ...
            //5.0 - filter shadow conversations
            ...
            //5.2 - conversation and conversation modality registration
            ...
            //5.3 - add selected contacts to the meeting
            ...
            //5.4 - send first IM message that initiates meeting invitation
        ...
        {
            //7.0 - participant event registration: IM modality and content sharing modality
        ...
        {
            //8.0 Add participant URI to meeting participant list on UI
        ...
        void Modality_ModalityStateChanged(object sender, ModalityStateChangedEventArgs e)
        {
            ...
            //12.0 - show changes in conversation content sharing modality state
        ...
        {
            //3.0 - Get all Contact objects from contact list
        ...
        {
            //6.0 - detecting a shadow conversation
