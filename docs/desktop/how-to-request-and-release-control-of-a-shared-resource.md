...
<tbody>
<tr class="odd">
<td><p>When a user has started sharing a local resource, hiding the sharing stage of the conversation window or minimizing the window does not stop the resource sharing.</p></td>
</tr>
</tbody>
</table>
