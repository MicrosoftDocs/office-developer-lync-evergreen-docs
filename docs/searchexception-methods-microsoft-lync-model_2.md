---
title: SearchException methods (Microsoft.Lync.Model)
TOCTitle: SearchException methods
ms:assetid: Methods.T:Microsoft.Lync.Model.SearchException_DI_3_UC_OCS14MrefLyncWPF
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.lync.model.searchexception_di_3_uc_ocs14mreflyncwpf_methods(v=office.15)
ms:contentKeyID: 48601061
ms.date: 07/28/2014
mtps_version: v=office.15
---

# SearchException methods
