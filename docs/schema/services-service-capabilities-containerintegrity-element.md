...
# services/service/capabilities/containerIntegrity element


**Applies to:** Lync 2013 | Lync Server 2013

Specifies the capability for a presentity to manage container integrity.

```xml
<capabilities uri="uri" preferred="boolean" [anyAttr]="anyattr" 
              xmlns="http://schemas.microsoft.com/2006/09/sip/device">     <containerIntegrity 
          preferred="boolean" 
...
The following XML code snippet describes a service capability to maintain container integrity for the user, sip:alice@contoso.com.

    <se:service xmlns:se="http://schemas.microsoft.com/2006/09/sip/service">
      <se:capabilities>
        <se:containerIntegrity uri="sip:alice@contoso.com" render="true" publish="true" />
      </se:capabilities>
    </se:service>
