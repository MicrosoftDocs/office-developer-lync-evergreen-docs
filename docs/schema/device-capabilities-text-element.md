...
# device/capabilities/text element


**Applies to:** Lync 2013 | Lync Server 2013

Specifies the capability for instant messaging on a device.
...
The following XML code snippet describes a presence capability for instant messaging on a device named "BOB\_client".
