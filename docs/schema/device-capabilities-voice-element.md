---
title: device/capabilities/voice element
TOCTitle: device/capabilities/voice element
ms:assetid: 44d648cf-2397-49d1-8858-b98a94a089c2
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Dn454735(v=office.15)
ms:contentKeyID: 57093578
ms.date: 07/24/2014
...
The following XML code snippet describes a presence capability for voice calling on a device named "BOB\_client".
    ...
    <de:device xmlns:de="http://schemas.microsoft.com/2006/09/sip/device" 
      ...
      <de:capabilities preferred="false" uri="sip:bob@contoso.com">
         <de:voice capture="false" render="boolean" publish="false" />
      </de:capabilities>
