...
# device/capabilities/contentNativeFile element


_**Applies to:** Lync 2013 | Lync Server 2013_

Specifies the capability for content sharing using native files on this device. This is introduced in the Microsoft Lync Server 2010 release.
