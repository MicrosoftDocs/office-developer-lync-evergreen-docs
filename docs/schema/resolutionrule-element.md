---
title: resolutionRule element
TOCTitle: resolutionRule element
ms:assetid: 2ee94d74-80f1-4d98-b189-4aaa2f03ac3a
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Dn439013(v=office.15)
ms:contentKeyID: 57094057
ms.date: 07/24/2014
...
<tr class="odd">
<td><p>type</p></td>
<td><p>A token specifying the type of this resolution rule. Supported tokens are removeFromContainer, moveToDefaultContainer and forceRole.</p></td>
</tr>
<tr class="even">
<td><p>role</p></td>
<td><p>A token specifying the role of the member. Supported tokens are delegate and buddy.</p></td>
</tr>
<tr class="odd">
...
<td><p>The list of resolution rules containing this resolution rule.</p></td>
</tr>
</tbody>
</table>
