---
title: device/capabilities/contentPowerPoint element
TOCTitle: device/capabilities/contentPowerPoint element
ms:assetid: 2dee5d62-773e-45c9-92fa-30b183e8b728
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Dn454749(v=office.15)
ms:contentKeyID: 57093636
ms.date: 07/24/2014
...
# device/capabilities/contentPowerPoint element


_**Applies to:** Lync 2013 | Lync Server 2013_

Specifies the capability for content sharing with PowerPoint on this device. This is introduced in the Microsoft Lync Server 2010 release.
...
The following XML code snippet describes a presence capability for application sharing on a device named "BOB\_client".
