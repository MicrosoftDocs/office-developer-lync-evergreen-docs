...
The following XML code snippet describes a service capability to handle video for the user, sip:alice@contoso.com.

    <se:service xmlns:se="http://schemas.microsoft.com/2006/09/sip/service">
      <se:capabilities>
        <se:video uri="sip:alice@contoso.com" render="true" publish="true" />
      </se:capabilities>
    </se:service>
