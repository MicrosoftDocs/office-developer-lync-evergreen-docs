...
# device/capabilities/ucs element


**Applies to:** Lync 2013 | Lync Server 2013

Specifies the UCS capability on a device. This is introduced in the Microsoft Lync Server 2010 release.
...
The following XML code snippet describes a presence capability of the unified contact store support on a device named "BOB\_client".
    ...
    <de:device xmlns:de="http://schemas.microsoft.com/2006/09/sip/device" 
      ...
      <de:capabilities preferred="false" uri="sip:bob@contoso.com">
         <de:ucs capture="false" render="true" publish="false" />
      </de:capabilities>
