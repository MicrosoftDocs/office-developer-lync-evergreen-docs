...
# services/service/capabilities/voice element
...
The following XML code snippet describes a service capability to handle voice calls by the user, sip:alice@contoso.com.

    <se:service xmlns:se="http://schemas.microsoft.com/2006/09/sip/service">
      <se:capabilities>
        <se:voice uri="sip:alice@contoso.com" render="true" publish="true" />
      </se:capabilities>
    </se:service>
