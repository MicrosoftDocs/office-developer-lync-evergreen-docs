...
# device/capabilities/isfInk element


_**Applies to:** Lync 2013 | Lync Server 2013_

Specifies the capability for handling ISF images on this device.
...
The following XML code snippet describes a presence capability for handling ISF images on a device named "BOB\_client".
