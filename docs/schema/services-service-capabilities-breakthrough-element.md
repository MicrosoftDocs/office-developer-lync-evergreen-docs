...
# services/service/capabilities/breakthrough element


**Applies to:** Lync 2013 | Lync Server 2013

Specifies the presence capability for a presentity to break through.
...
The following XML code snippet describes a service capability to handle breakthrough for the user, sip:alice@contoso.com.

    <se:service xmlns:se="http://schemas.microsoft.com/2006/09/sip/service">
      <se:capabilities>
        <se:breakthrough uri="sip:alice@contoso.com" render="true" publish="true" />
      </se:capabilities>
    </se:service>
