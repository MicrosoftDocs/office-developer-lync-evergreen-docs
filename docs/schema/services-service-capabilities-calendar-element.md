...
# services/service/capabilities/calendar element
...
<tr class="odd">
<td><p>uri</p></td>
<td><p>Optional attribute to specify the user’s SMTP address in Exchange.</p></td>
</tr>
<tr class="even">
<td><p>render</p></td>
<td><p>Optional attribute as a Boolean flag to indicate whether the presence service can render this type of presence data (true) or not (false). The default value is false.</p></td>
</tr>
<tr class="odd">
<td><p>capture</p></td>
<td><p>Optional attribute as a Boolean flag to indicate whether the presence service can capture this type of presence data (true) or not (false). The default value is false.</p></td>
</tr>
<tr class="even">
<td><p>publish</p></td>
<td><p>Optional attribute as a Boolean flag to indicate whether the presence service can publish this type of presence data (true) or not (false). The default value is false.</p></td>
</tr>
<tr class="odd">
<td><p>version</p></td>
...
<td><p>Optional attribute to show the availability number of the reachable device.</p></td>
</tr>
<tr class="odd">
<td><p>[anyAttr]</p></td>
...
The following XML code snippet describes a service capability to handle calendar data for the user, alice@contoso.com.
...
[services/service/capabilities element](services-service-capabilities-element.md)
