---
title: RequestCanceledException members (Microsoft.Lync.Model)
TOCTitle: RequestCanceledException members
ms:assetid: AllMembers.T:Microsoft.Lync.Model.RequestCanceledException_DI_3_UC_OCS14MrefLyncWPF
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.lync.model.requestcanceledexception_di_3_uc_ocs14mreflyncwpf_members(v=office.15)
ms:contentKeyID: 48589281
ms.date: 07/28/2014
mtps_version: v=office.15
---

# RequestCanceledException members
...
The [RequestCanceledException](requestcanceledexception-class-microsoft-lync-model_2.md) type exposes the following members.
...
<td><a href="requestcanceledexception-constructor-microsoft-lync-model_1.md">RequestCanceledException</a></td>
<td>Initializes a new instance of the RequestCanceledException class with serialized data.</td>
</tr>
</tbody>
</table>
