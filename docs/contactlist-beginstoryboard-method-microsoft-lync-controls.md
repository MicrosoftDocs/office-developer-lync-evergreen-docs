---
title: ContactList.BeginStoryboard method  (Microsoft.Lync.Controls)
TOCTitle: 'BeginStoryboard method '
ms:assetid: Overload:Microsoft.Lync.Controls.ContactList.BeginStoryboard_DI_3_UC_OCS14MrefLyncWPF
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.lync.controls.contactlist.beginstoryboard_di_3_uc_ocs14mreflyncwpf(v=office.15)
ms:contentKeyID: 48601200
ms.date: 07/28/2014
mtps_version: v=office.15
f1_keywords:
- Microsoft.Lync.Controls.ContactList.BeginStoryboard
dev_langs:
- CSharp
- JScript
- VB
...
# ContactList.BeginStoryboard method
