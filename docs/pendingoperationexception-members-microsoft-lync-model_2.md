---
title: PendingOperationException members (Microsoft.Lync.Model)
TOCTitle: PendingOperationException members
ms:assetid: AllMembers.T:Microsoft.Lync.Model.PendingOperationException_DI_3_UC_OCS14MrefLyncWPF
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.lync.model.pendingoperationexception_di_3_uc_ocs14mreflyncwpf_members(v=office.15)
ms:contentKeyID: 48592234
ms.date: 07/28/2014
mtps_version: v=office.15
---

# PendingOperationException members
...
The [PendingOperationException](pendingoperationexception-class-microsoft-lync-model_2.md) type exposes the following members.
...
<td><a href="pendingoperationexception-constructor-microsoft-lync-model_1.md">PendingOperationException</a></td>
<td>Initializes a new instance of the PendingOperationException class with serialized data.</td>
</tr>
</tbody>
</table>
