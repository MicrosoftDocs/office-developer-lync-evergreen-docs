---
title: MSDiagnostics element (MessageProperties complexType) (Lync SDN Interface 2.1.1)
TOCTitle: MSDiagnostics element (MessageProperties complexType)
ms:assetid: 5bcfcaa7-d8d3-488b-1758-d1e5fdd0c2d0
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Dn912762(v=office.15)
ms:contentKeyID: 64126932
ms.date: 02/16/2015
...
# MSDiagnostics element (MessageProperties complexType) (Lync SDN Interface 2.1.1)

Lync-specific diagnostics message.
