---
title: ItemAlreadyExistException members (Microsoft.Lync.Model)
TOCTitle: ItemAlreadyExistException members
ms:assetid: AllMembers.T:Microsoft.Lync.Model.ItemAlreadyExistException_DI_3_UC_OCS14MrefLyncWPF
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.lync.model.itemalreadyexistexception_di_3_uc_ocs14mreflyncwpf_members(v=office.15)
ms:contentKeyID: 48601835
ms.date: 07/28/2014
mtps_version: v=office.15
---

# ItemAlreadyExistException members
...
The [ItemAlreadyExistException](itemalreadyexistexception-class-microsoft-lync-model_2.md) type exposes the following members.
...
<td><a href="itemalreadyexistexception-constructor-microsoft-lync-model_1.md">ItemAlreadyExistException</a></td>
<td>Initializes a new instance of the ItemAlreadyExistException class with serialized data.</td>
</tr>
</tbody>
</table>
